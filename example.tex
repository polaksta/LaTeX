...
\mode<beamer>{ 	% In the 'beamer' mode
	...
	\hypersetup{pdfpagemode=FullScreen,colorlinks,linkcolor=,urlcolor=links}         % Enable Full screen mode
...
\begin{frame}{\iflanguage{polish}{Otoczenia matematyczne}{Math environments}}
	\begin{columns}
		...
		\begin{proof}The latest version of the template is available at \url{https://github.com/polaksta/beamer-AGH/archive/refs/heads/master.zip}
			\ldots
		\end{proof}
	\end{columns}
	\vfill
...
\begin{frame}[fragile]{\iflanguage{polish}{Informacje}{Information}}
	\iflanguage{polish}{Aktualna wersja szablonu jest dostępna pod adresem \url{https://github.com/polaksta/beamer-AGH/archive/refs/heads/master.zip}}{The current version of the template is available at \url{https://github.com/polaksta/beamer-AGH/archive/refs/heads/master.zip}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%		
