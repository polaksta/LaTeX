...
%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Usage of the listings environment}
...
\end{frame}
%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Usage of the minted environment}
	\begin{minted}[frame=single,beameroverlays,linenos,escapeinside=||]{C++}
/* The first  program in C++ */  |\pause|
#include <iostream>  |\pause|
using namespace std; |\pause|
void main() 
