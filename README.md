...
| If you want to hide a sidebar (with AGH logo and tri-color strip) for non-title slides, you should use *nosidebar* option, i.e. `\usetheme[nosidebar]{AGH}` | Jeżeli chcesz ukryć pasek boczny (zawierający logo AGH plus trójkolorowy pasek) dla sladów nietytułowych, to użyj opcji *nosidebar*, tzn. `\usetheme[nosidebar]{AGH}` 
