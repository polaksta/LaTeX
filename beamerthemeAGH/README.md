...
| --------   | ------- |------- |
| default    | Stonowany i minimalistyczny motyw. Tytuł slajdu jest równany do lewej strony. Slajd nie posiada ani nagłówka, ani stopki. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-default.png "Slajd") |
| infolines  | Nagłówek zawiera tytuł bieżącej sekcji oraz podsekcji. Stopka zawiera: imię i nazwisko autora, nazwę instytutu/uczelni, tytuł prezentacji, aktualną datę oraz numer slajdu. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-infolines.png "Slajd") |
| miniframes | Nagłówek zawiera poziomy pasek nawigacyjny, którego elementami są małe kółka — reprezentują poszczególne slajdy sekcji. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-miniframes.png "Slajd") |
| smoothbars | Motyw ten zachowuje się bardzo podobnie do motywu **miniframes**, przynajmniej w odniesieniu do nagłówka. Jedyną różnicą są płynne przejścia kolorystyczne pomiędzy kolorami tła pasków slajdu.  Domyślnie, slajdy nie posiadają stopki. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-smoothbars.png "Slajd") |
| sidebar    | Z lewej strony slajdu znajduje się pasek ze spisem treści prezentacji. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-sidebar.png "Slajd") |
| split      | Lewa część nagłówka zawiera tytuł sekcji, a w prawa, podrozdziały bieżącej sekcji.| ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-split.png "Slajd") |
| shadow     | Rozszerzona wersja motywu **split** — poziome cieniowanie za tytułem slajdu oraz dodawany jest mały „cień” na dole nagłówka. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-shadow.png "Slajd") |
| tree       | Nagłówek zawiera trzy linie, które pokazują tytuł prezentacji, tytuł bieżącej sekcji oraz podsekcji. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-tree.png "Slajd") |
| smoothtree | Motyw podobny do **tree**. Główną różnicą jest płynna zmiana kolorów tła. | ![Screenshot](https://home.agh.edu.pl/~polak/img/beamer-AGH-smoothtree.png "Slajd") |
...
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| ![Screenshot](http://home.agh.edu.pl/~polak/img/beamer-AGH.big.png "Slajd tytułowy") | ![Screenshot](http://home.agh.edu.pl/~polak/img/beamer-AGH-dark.big.png "Slajd tytułowy — wersja ciemna") |
...
- [Prezentacja 1](https://home.agh.edu.pl/~polak/pdf/beamer/beamer1.pdf)
- [Prezentacja 2](http://home.agh.edu.pl/~polak/pdf/beamer/beamer2.pdf)
- [Prezentacja 3 — wersja z ciemnym tłem](http://home.agh.edu.pl/~polak/pdf/beamer/beamer3.pdf)
